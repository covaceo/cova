...
test('Astra styles load after the legacy dashboard cascade', () => {
  ...
  assert.deepEqual(imports.slice(astra + 1), ['./styles/approvedDashboard.css', './styles/approvedWorkspace.css', './styles/userProfile.css', './styles/tradeHistory.css', './styles/homeStory.css', './styles/publicPassportExample.css', './styles/siteInteractionPolish.css', './styles/deskJournal.css', './styles/workspaceUtility.css', './styles/passportProgress.css', './styles/tradingCalendar.css'], 'Only scoped public/card/interaction styles follow Astra');
});
