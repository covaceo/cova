...
export const propFirmOptions: {
  ...
  },
  {
    ...
    name: "Rithmic",
    badge: "Direct sync",
    route: "Rithmic account sync",
    platforms: "Rithmic / R|Trader",
    status: "advanced",
    summary: "Import completed trade history from Rithmic Paper Trading, Rithmic 01, or the provider Test environment.",
    fit: "Cova opens an on-demand R | Protocol API session, imports completed fills, then logs out and discards the login.",
    connectLabel: "Connect Rithmic account",
    connectNotice: "Choose your Rithmic environment. Credentials are used for one sync and discarded by Cova when it finishes.",
  },
  {
    id: "tradovate",
    name: "Tradovate",
