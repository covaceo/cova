  ...
  return (
    <div className={`min-h-screen bg-black text-white ${section === "dashboard" ? "oa-dashboard-app" : ""}`}>
      ...
      <Navbar
        ...
        riskScore={analysis.activeRuleCount ? analysis.score : Number.NaN}
        signOut={signOut}
